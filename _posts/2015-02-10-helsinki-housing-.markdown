...
some data munging with R is required - you can see how I did it <a target="_blank" href="">here MISSING</a>.
...
Find the whole R code to produce the Shinyapp and plots on <a target="_blank" href="https//github.com/jcarlosmayo/helsinki_housing">GitHub</a>.
